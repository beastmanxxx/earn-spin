...
import { Mail, Lock, Sparkles, User, Tag, ArrowLeft } from "lucide-react";
...
export const Route = createFileRoute("/auth")({
  head: () => ({
    meta: [
      { title: "Authentication — EarnSpin Rewards" },
      { name: "description", content: "Login or Sign up to EarnSpin Rewards." },
    ],
  }),
...
function AuthScreen() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <Link to="/" className="fixed top-4 left-4 p-2 text-muted-foreground hover:text-foreground transition-colors glass rounded-full">
      ...
      <PhoneFrame>
        <div className="flex-1 flex flex-col px-6 pt-12 pb-6">
          ...
          <p className="text-[10px] text-center text-muted-foreground mt-auto pt-6">
            By continuing, you agree to our <Link to="/terms-of-service" className="underline">Terms</Link> and <Link to="/privacy-policy" className="underline">Privacy Policy</Link>
          </p>
        </div>
      </PhoneFrame>
    </div>
